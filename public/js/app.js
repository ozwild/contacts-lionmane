...
window.app = __webpack_require__(36);
...
license Apache-2.0
*/
!function(t,i){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(s){return i(s,t)}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
var app = {
    ...
    actions: {
        refresh: function refresh() {
            var self = app;
            return $.get(self.routes.list).done(function (htmlResponse) {
                self.containers.index.html(htmlResponse);
            });
        },
        show: function show(ref) {
            return $.get(ref).done(function (htmlResponse) {
        ...
        store: function store(data) {
            var self = this;
            return $.post(app.routes.store, data).done(function () {
                self.refresh();
                app.hideModal();
        ...
        delete: function _delete(ref) {
            ...
            return $.post(ref, { _method: "delete" }).done(function () {
                self.refresh();
                app.hideModal();
    ...
    handleErrorMessages: function handleErrorMessages(data) {
        var messages = [];
        for (key in data) {
    ...
    retrieveTemplates: function retrieveTemplates() {
        var self = this;
        return $.get(self.routes.create).done(function (htmlResponse) {
